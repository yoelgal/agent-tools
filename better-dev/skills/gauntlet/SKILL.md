...
smallest units the loop can better and grade on their own; it **fans those units out to subagents** -
...
> grade independently - the split is yours. Fan them out to subagents: one builder and one harsh
...
clipboard command. With it, four run notes: paste into a fresh session of the named harness, not
...
operator's to flip and it costs materially more; monitoring happens on the progress surface, so resist
